...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-teal-900 py-4 px-6 flex items-center justify-between relative z-10">
      ...
      <div className="hidden lg:flex space-x-4 items-center">
        <Link href="/loginLearner">
          <button className="border bg-white text-black border-gray-400  px-4 py-2 rounded">
            Learner Login
          </button>
        </Link>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden absolute top-16 left-0 w-full h-screen bg-[#F1F1F1] flex flex-col items-center space-y-4 py-4 text-gray-700 z-20">
          ...
          <button className="border border-gray-400 text-gray-700 px-4 py-2 rounded w-3/4">
            Learner Login
          </button>
